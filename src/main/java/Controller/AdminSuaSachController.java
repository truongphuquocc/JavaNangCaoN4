...
/**
 * Servlet implementation class AdminSuaSachController
 */
    ...
    try {
      ...
      if (ad != null) {
        ...
        try {
          ...
          sach.editBook2(masach, tensach, tacgia, Long.parseLong(gia), Long.parseLong(soluong),
              anhupload, maloai, ngay, sotap);
